          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50">
              ...
              <div className="flex gap-6 mb-8">
                <a 
                  href={featuredProjects[currentProject].live}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-6 py-3 border border-gray-600 text-gray-300 rounded-lg hover:border-teal-500 hover:text-teal-400 transition-all duration-300 text-base font-medium hover:bg-teal-500/10 cursor-pointer flex items-center gap-2"
                >
                  🚀 Live Demo
                </a>
                <a 
